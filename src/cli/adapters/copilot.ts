...
const EVENT_NAMES = new Set<CopilotEventName>([
  'PreToolUse',
  'PermissionRequest',
  'PostToolUse',
  'SessionStart',
...
function eventName(value: unknown): CopilotEventName | undefined {
  return typeof value === 'string' && EVENT_NAMES.has(value as CopilotEventName)
    ? value as CopilotEventName
    : undefined;
}
...
function inferOutputEvent(result: HookResult): CopilotEventName | undefined {
